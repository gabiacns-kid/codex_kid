...
- For Google Ads proposal decisions based on the official Help Center, including campaign selection, Search versus Demand Gen versus Performance Max, primary/secondary conversions, Smart Bidding learning, enhanced conversions, consent, keyword matching, negative keywords, budget adequacy, and advertiser verification: read `references/google-ads-help-decision-framework-202608.md`.
- For Meta Ads proposal decisions based on the official Business Help Center, including objective and conversion-location selection, campaign/ad-set/ad structure, budget consolidation, Advantage+ audience and placements, lead quality, Pixel and Conversions API measurement, Reels creative, experiments, billing, account permissions, and policy checks: read `references/meta-ads-help-decision-framework-202608.md`.
...
- For Daangn Expert Mode native ads, `Brand Store Visit Growth` campaigns, franchise or multi-location brand advertising, headquarters-managed Business Profiles, location-based nearest-store landing, store-level budgets and bids, and Daangn local targeting: read `references/daangn-native-brand-store-visit-202608.md`.
